...
async function seedLeadTemplates(ds: any) {
  ...
  const fieldsData: Array<{
    ...
    { catCode: 'RESIDENTIAL', fieldKey: 'householdAges', fieldName: 'Ages of occupants', fieldType: 'text', section: 'Household Profile', capturedAtStage: 'Lead', isRequired: false, displayOrder: 2 },
    ...
    { catCode: 'RESIDENTIAL', fieldKey: 'commonAmenities', fieldName: 'Common Amenities (club, pool, gym, etc.)', fieldType: 'text', section: 'Apartments (additional)', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 31 },
    ...
    { catCode: 'RESIDENTIAL', fieldKey: 'marketingCollaterals', fieldName: 'Marketing Collaterals Needed (brochures, walkthroughs)', fieldType: 'text', section: 'Apartments (additional)', capturedAtStage: 'Client Brief', isRequired: false, displayOrder: 33 },
    ...
    { catCode: 'SCHOOLS', fieldKey: 'gradesRange', fieldName: 'Grades Range & Sections', fieldType: 'text', section: 'Institution Profile', capturedAtStage: 'Lead', isRequired: false, displayOrder: 2 },
    ...
    { catCode: 'SCHOOLS', fieldKey: 'labsList', fieldName: 'Labs (physics, chemistry, biology, computer, etc.)', fieldType: 'multi-select', fieldOptions: ['Physics', 'Chemistry', 'Biology', 'Computer', 'Language', 'Maths'], section: 'Academic Spaces', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 7 },
    { catCode: 'SCHOOLS', fieldKey: 'library', fieldName: 'Library Space', fieldType: 'yes-no', section: 'Academic Spaces', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 8 },
    ...
    { catCode: 'SCHOOLS', fieldKey: 'indoorSports', fieldName: 'Indoor Sports Space (badminton, table tennis)', fieldType: 'text', section: 'Assembly & Sports', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 14 },
    ...
    { catCode: 'SCHOOLS', fieldKey: 'transportBusesParking', fieldName: 'Transport — Bus Bays & Parking', fieldType: 'text', section: 'Support Spaces', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 19 },
    { catCode: 'SCHOOLS', fieldKey: 'toiletsPerNorms', fieldName: 'Toilets per Norms', fieldType: 'yes-no', section: 'Support Spaces', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 20 },
    { catCode: 'SCHOOLS', fieldKey: 'hostelWarden', fieldName: 'Hostel & Warden Rooms (if boarding)', fieldType: 'yes-no', section: 'Support Spaces', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 21 },
    ...
    { catCode: 'SCHOOLS', fieldKey: 'affiliationNorms', fieldName: 'Affiliation Norms (land area, room sizes)', fieldType: 'text', section: 'Compliance', capturedAtStage: 'Client Brief', isRequired: false, displayOrder: 23 },
    { catCode: 'SCHOOLS', fieldKey: 'fireNoc', fieldName: 'Fire NOC & Child-Safety Norms', fieldType: 'yes-no', section: 'Compliance', capturedAtStage: 'Client Brief', isRequired: false, displayOrder: 24 },
    { catCode: 'SCHOOLS', fieldKey: 'barrierFreeAccess', fieldName: 'Barrier-Free Access Required', fieldType: 'yes-no', section: 'Compliance', capturedAtStage: 'Client Brief', isRequired: false, displayOrder: 25 },
    ...
    // 3.3 Institutional
    { catCode: 'INSTITUTIONAL', fieldKey: 'instType', fieldName: 'Institutional Type', fieldType: 'single-select', fieldOptions: ['Arts & Science', 'Engineering', 'Training', 'Community Hall', 'Religious'], section: 'Institution Profile', capturedAtStage: 'Lead', isRequired: true, displayOrder: 1 },
    { catCode: 'INSTITUTIONAL', fieldKey: 'governingBodyApprovals', fieldName: 'Governing Body & Approvals (UGC/AICTE)', fieldType: 'text', section: 'Institution Profile', capturedAtStage: 'Lead', isRequired: false, displayOrder: 2 },
    ...
    { catCode: 'INSTITUTIONAL', fieldKey: 'departmentsIntake', fieldName: 'Departments & Intake', fieldType: 'text', section: 'Academic / Functional Spaces', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 4 },
    ...
    { catCode: 'INSTITUTIONAL', fieldKey: 'library', fieldName: 'Library', fieldType: 'yes-no', section: 'Academic / Functional Spaces', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 6 },
    { catCode: 'INSTITUTIONAL', fieldKey: 'auditoriumCapacity', fieldName: 'Auditorium / Convention Capacity', fieldType: 'number', section: 'Academic / Functional Spaces', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 7 },
    { catCode: 'INSTITUTIONAL', fieldKey: 'examHalls', fieldName: 'Exam Halls', fieldType: 'text', section: 'Academic / Functional Spaces', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 8 },
    { catCode: 'INSTITUTIONAL', fieldKey: 'hostelsCapacity', fieldName: 'Hostels Capacity (gender-wise)', fieldType: 'text', section: 'Residential & Support', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 9 },
    ...
    { catCode: 'INSTITUTIONAL', fieldKey: 'diningKitchen', fieldName: 'Dining & Kitchen', fieldType: 'yes-no', section: 'Residential & Support', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 11 },
    { catCode: 'INSTITUTIONAL', fieldKey: 'guestHouse', fieldName: 'Guest House', fieldType: 'yes-no', section: 'Residential & Support', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 12 },
    { catCode: 'INSTITUTIONAL', fieldKey: 'adminBlock', fieldName: 'Admin Block', fieldType: 'text', section: 'Residential & Support', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 13 },
    ...
    { catCode: 'INSTITUTIONAL', fieldKey: 'parkingSpaces', fieldName: 'Bus / Car / Two-wheeler Parking', fieldType: 'text', section: 'Site & Movement', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 15 },
    { catCode: 'INSTITUTIONAL', fieldKey: 'campusPhasingMasterPlan', fieldName: 'Campus Phasing & Master Plan Needs', fieldType: 'text', section: 'Site & Movement', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 16 },
    { catCode: 'INSTITUTIONAL', fieldKey: 'sportsFacilities', fieldName: 'Sports Facilities', fieldType: 'text', section: 'Site & Movement', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 17 },
    { catCode: 'INSTITUTIONAL', fieldKey: 'securityCompound', fieldName: 'Security & Compound', fieldType: 'text', section: 'Site & Movement', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 18 },
    { catCode: 'INSTITUTIONAL', fieldKey: 'statutoryBodyNorms', fieldName: 'Statutory Body Norms (built-up/student, lab)', fieldType: 'text', section: 'Compliance', capturedAtStage: 'Client Brief', isRequired: false, displayOrder: 19 },
    { catCode: 'INSTITUTIONAL', fieldKey: 'fireNoc', fieldName: 'Fire NOC', fieldType: 'yes-no', section: 'Compliance', capturedAtStage: 'Client Brief', isRequired: false, displayOrder: 20 },
    { catCode: 'INSTITUTIONAL', fieldKey: 'barrierFreeAccess', fieldName: 'Barrier-free access', fieldType: 'yes-no', section: 'Compliance', capturedAtStage: 'Client Brief', isRequired: false, displayOrder: 21 },
    { catCode: 'INSTITUTIONAL', fieldKey: 'pcbSTP', fieldName: 'PCB (hostel STP) where applicable', fieldType: 'text', section: 'Compliance', capturedAtStage: 'Client Brief', isRequired: false, displayOrder: 22 },
    ...
    { catCode: 'HOSPITALS', fieldKey: 'bedCount', fieldName: 'Bed Count & Mix (general/semi-private/private/deluxe/ICU/NICU)', fieldType: 'text', section: 'Facility Profile', capturedAtStage: 'Lead', isRequired: true, displayOrder: 2 },
    ...
    { catCode: 'HOSPITALS', fieldKey: 'otCountTypes', fieldName: 'OT Count & Types (general/modular/cath lab)', fieldType: 'text', section: 'Clinical Programme', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 5 },
    ...
    { catCode: 'HOSPITALS', fieldKey: 'ptsStations', fieldName: 'PTS stations', fieldType: 'yes-no', section: 'Special Systems', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 22 },
    { catCode: 'HOSPITALS', fieldKey: 'wtpRoDialysis', fieldName: 'WTP / RO for dialysis', fieldType: 'yes-no', section: 'Special Systems', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 23 },
    { catCode: 'HOSPITALS', fieldKey: 'upsPowerBackup', fieldName: 'UPS & power-backup criticality', fieldType: 'text', section: 'Special Systems', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 24 },
    { catCode: 'HOSPITALS', fieldKey: 'medicalIt', fieldName: 'Medical IT (PACS, nurse call)', fieldType: 'text', section: 'Special Systems', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 25 },
    { catCode: 'HOSPITALS', fieldKey: 'staffCounts', fieldName: 'Doctors / nurses / staff counts', fieldType: 'text', section: 'People & Movement', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 26 },
    ...
    { catCode: 'HOSPITALS', fieldKey: 'staffFacilities', fieldName: 'Staff facilities & on-call rooms', fieldType: 'text', section: 'People & Movement', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 28 },
    ...
    { catCode: 'HOSPITALS', fieldKey: 'circulationSegregation', fieldName: 'Segregation of clean / dirty & patient / service circulation', fieldType: 'text', section: 'People & Movement', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 32 },
    { catCode: 'HOSPITALS', fieldKey: 'clinicalEstablishments', fieldName: 'Clinical Establishments registration', fieldType: 'yes-no', section: 'Compliance', capturedAtStage: 'Client Brief', isRequired: false, displayOrder: 33 },
    ...
    { catCode: 'HOSPITALS', fieldKey: 'pcbBiomedicalWaste', fieldName: 'PCB consents & biomedical waste authorisation', fieldType: 'text', section: 'Compliance', capturedAtStage: 'Client Brief', isRequired: false, displayOrder: 35 },
    { catCode: 'HOSPITALS', fieldKey: 'aerbRadiology', fieldName: 'AERB (radiology)', fieldType: 'yes-no', section: 'Compliance', capturedAtStage: 'Client Brief', isRequired: false, displayOrder: 36 },
    { catCode: 'HOSPITALS', fieldKey: 'nabhAspirations', fieldName: 'NABH aspirations', fieldType: 'yes-no', section: 'Compliance', capturedAtStage: 'Client Brief', isRequired: false, displayOrder: 37 },
    { catCode: 'HOSPITALS', fieldKey: 'liftDgApprovals', fieldName: 'Lift & DG approvals', fieldType: 'yes-no', section: 'Compliance', capturedAtStage: 'Client Brief', isRequired: false, displayOrder: 38 },
    ...
    { catCode: 'HOSPITALITY', fieldKey: 'kidsRecreation', fieldName: 'Kids / Recreation area', fieldType: 'text', section: 'Guest Facilities', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 10 },
    ...
    { catCode: 'HOSPITALITY', fieldKey: 'laundryBO', fieldName: 'Laundry Back of House', fieldType: 'text', section: 'Back of House', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 14 },
    { catCode: 'HOSPITALITY', fieldKey: 'staffFacilities', fieldName: 'Staff dining, lockers & accommodation', fieldType: 'text', section: 'Back of House', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 15 },
    ...
    { catCode: 'HOSPITALITY', fieldKey: 'circulationSegregation', fieldName: 'Service & Guest Circulation Segregation', fieldType: 'yes-no', section: 'Operations', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 20 },
    ...
    { catCode: 'HOSPITALITY', fieldKey: 'barLicence', fieldName: 'Bar licence provisions', fieldType: 'text', section: 'Compliance', capturedAtStage: 'Client Brief', isRequired: false, displayOrder: 25 },
    { catCode: 'HOSPITALITY', fieldKey: 'tourismClassification', fieldName: 'Tourism department classification', fieldType: 'text', section: 'Compliance', capturedAtStage: 'Client Brief', isRequired: false, displayOrder: 26 },
    { catCode: 'HOSPITALITY', fieldKey: 'poolSafety', fieldName: 'Pool safety norms compliance', fieldType: 'yes-no', section: 'Compliance', capturedAtStage: 'Client Brief', isRequired: false, displayOrder: 27 },
    ...
    { catCode: 'COMMERCIAL', fieldKey: 'gradeAspiration', fieldName: 'Grade Aspiration (A / B)', fieldType: 'single-select', fieldOptions: ['Grade A', 'Grade B'], section: 'Business Profile', capturedAtStage: 'Lead', isRequired: false, displayOrder: 4 },
    ...
    { catCode: 'COMMERCIAL', fieldKey: 'liftsEscalators', fieldName: 'Lifts & Escalators count/spec', fieldType: 'text', section: 'Building Systems', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 16 },
    { catCode: 'COMMERCIAL', fieldKey: 'facadeSignage', fieldName: 'Façade aspirations & signage zones', fieldType: 'text', section: 'Building Systems', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 17 },
    { catCode: 'COMMERCIAL', fieldKey: 'parkingCap', fieldName: 'Car & Two-wheeler Parking per norms', fieldType: 'text', section: 'Site & Parking', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 18 },
    { catCode: 'COMMERCIAL', fieldKey: 'loadingUnloading', fieldName: 'Loading / Unloading & Service Yards', fieldType: 'text', section: 'Site & Parking', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 19 },
    ...
    { catCode: 'COMMERCIAL', fieldKey: 'occupancyCertificatePath', fieldName: 'Occupancy certificate path', fieldType: 'text', section: 'Compliance & Ratings', capturedAtStage: 'Client Brief', isRequired: false, displayOrder: 23 },
    ...
    { catCode: 'INDUSTRIAL', fieldKey: 'processFlow', fieldName: 'Process flow description (inputs -> production -> dispatch)', fieldType: 'text', section: 'Industry Profile', capturedAtStage: 'Lead', isRequired: false, displayOrder: 2 },
    { catCode: 'INDUSTRIAL', fieldKey: 'productionCapacityShifts', fieldName: 'Production Capacity & Shifts details', fieldType: 'text', section: 'Industry Profile', capturedAtStage: 'Lead', isRequired: false, displayOrder: 3 },
    { catCode: 'INDUSTRIAL', fieldKey: 'pcbCategory', fieldName: 'PCB Category (red / orange / green / white)', fieldType: 'single-select', fieldOptions: ['Red', 'Orange', 'Green', 'White'], section: 'Industry Profile', capturedAtStage: 'Lead', isRequired: false, displayOrder: 4 },
    ...
    { catCode: 'INDUSTRIAL', fieldKey: 'machineryList', fieldName: 'Machinery list with sizes, loads & vibration specs', fieldType: 'text', section: 'Production Needs', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 6 },
    { catCode: 'INDUSTRIAL', fieldKey: 'clearHeightsSpans', fieldName: 'Clear heights & spans requirements', fieldType: 'text', section: 'Production Needs', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 7 },
    { catCode: 'INDUSTRIAL', fieldKey: 'craneHoist', fieldName: 'Crane / Hoist requirements description', fieldType: 'text', section: 'Production Needs', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 8 },
    { catCode: 'INDUSTRIAL', fieldKey: 'floorLoading', fieldName: 'Floor loading & flatness standards', fieldType: 'text', section: 'Production Needs', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 9 },
    { catCode: 'INDUSTRIAL', fieldKey: 'cleanRoom', fieldName: 'Clean-room or controlled environments needs', fieldType: 'text', section: 'Production Needs', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 10 },
    { catCode: 'INDUSTRIAL', fieldKey: 'powerDemandSubstation', fieldName: 'Power demand & substation requirements', fieldType: 'text', section: 'Utilities', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 11 },
    { catCode: 'INDUSTRIAL', fieldKey: 'utilityEquipment', fieldName: 'Compressed air, steam, chillers description', fieldType: 'text', section: 'Utilities', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 12 },
    ...
    { catCode: 'INDUSTRIAL', fieldKey: 'etpWtpStp', fieldName: 'ETP / WTP / STP specs', fieldType: 'text', section: 'Utilities', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 14 },
    ...
    { catCode: 'INDUSTRIAL', fieldKey: 'storageVolumes', fieldName: 'Raw material & finished goods storage volumes', fieldType: 'text', section: 'Storage & Logistics', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 17 },
    { catCode: 'INDUSTRIAL', fieldKey: 'docksTruckMovement', fieldName: 'Docks & truck movement description', fieldType: 'text', section: 'Storage & Logistics', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 18 },
    ...
    { catCode: 'INDUSTRIAL', fieldKey: 'roadsTurningRadii', fieldName: 'Internal roads & turning radii specifications', fieldType: 'text', section: 'Storage & Logistics', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 20 },
    ...
    { catCode: 'INDUSTRIAL', fieldKey: 'adminBlock', fieldName: 'Admin block specs', fieldType: 'text', section: 'People Spaces', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 22 },
    { catCode: 'INDUSTRIAL', fieldKey: 'canteen', fieldName: 'Canteen specifications', fieldType: 'text', section: 'People Spaces', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 23 },
    { catCode: 'INDUSTRIAL', fieldKey: 'workersAmenities', fieldName: 'Workers\' amenities description', fieldType: 'text', section: 'People Spaces', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 24 },
    ...
    { catCode: 'INDUSTRIAL', fieldKey: 'visitorHandling', fieldName: 'Visitor handling description', fieldType: 'text', section: 'People Spaces', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 26 },
    { catCode: 'INDUSTRIAL', fieldKey: 'factoriesAct', fieldName: 'Factories Act / Inspectorate norms compliance', fieldType: 'text', section: 'Compliance', capturedAtStage: 'Client Brief', isRequired: false, displayOrder: 27 },
    { catCode: 'INDUSTRIAL', fieldKey: 'pcbConsent', fieldName: 'PCB consent to establish & operate', fieldType: 'text', section: 'Compliance', capturedAtStage: 'Client Brief', isRequired: false, displayOrder: 28 },
    ...
    { catCode: 'INDUSTRIAL', fieldKey: 'sipcotSez', fieldName: 'SIPCOT / SEZ / industrial-estate rules', fieldType: 'text', section: 'Compliance', capturedAtStage: 'Client Brief', isRequired: false, displayOrder: 30 },
    { catCode: 'INDUSTRIAL', fieldKey: 'explosiveBoiler', fieldName: 'Explosive / boiler licences requirements', fieldType: 'text', section: 'Compliance', capturedAtStage: 'Client Brief', isRequired: false, displayOrder: 31 },
    ...
    { catCode: 'MIXED_USE', fieldKey: 'entriesCores', fieldName: 'Independent vs shared entries and cores description', fieldType: 'text', section: 'Composition', capturedAtStage: 'Lead', isRequired: false, displayOrder: 3 },
    ...
    { catCode: 'MIXED_USE', fieldKey: 'sharedServices', fieldName: 'Shared services description (STP, DG, fire systems)', fieldType: 'text', section: 'Shared Systems', capturedAtStage: 'Requirement Collection', isRequired: false, displayOrder: 5 },
    ...
    { catCode: 'MIXED_USE', fieldKey: 'authorityTreatment', fieldName: 'Authority treatment of mixed use (premium FSI, separate NOCs)', fieldType: 'text', section: 'Compliance', capturedAtStage: 'Client Brief', isRequired: false, displayOrder: 7 },
  ...
  for (const f of fieldsData) {
    ...
    if (!existing) {
      const field = fieldRepo.create({
        ...
        section: f.section,
        capturedAtStage: f.capturedAtStage,
